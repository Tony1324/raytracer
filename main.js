...
// let world = new World([new Sphere(20,new Vector(0,0,30),{}),new Sphere(7,new Vector(10,5,10),{}),new Sphere(7,new Vector(-15,-10,16),{})])
 //let world = new World([
     //new Sphere(3, new Vector(4,3,8),{reflectivity:{r:1,g:1,b:1},glow:{r:200,g:200,b:200}}), 
 ...
 //])
 let world = new World([
     new Sphere(20, new Vector(0,0,50),{reflectivity:{r:1,g:0.8,b:0.4},glow:{r:50,g:25,b:10}}),
